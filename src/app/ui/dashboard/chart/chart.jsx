...
const data = [
  ...
  { name: 'Abr', Gastos: 2340.3, Minutos: 29143 },
  ...
  { name: 'Nov', Gastos: 1922.5, Minutos: 20342 },
    ...
    <div className={styles.container}>
      ...
      <div>
        <p className={styles.bigNumber}>
          Total Gasto: <b>$ 34.200</b>
        </p>
        <p className={styles.bigNumber}>
          Minutos Traduzidos: <b>383.928</b>
        </p>
      </div>
      <ResponsiveContainer width="100%" height={392}>
        ...
        >
          ...
          <Tooltip />
          <Legend />
          <Bar dataKey="Gastos" barSize={20} fill="#164e63" yAxisId="left" />
          <Line
            type="monotone"
            dataKey="Minutos"
